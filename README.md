...
- **当前版本:0.4preview 最后更新日期:20/7/24**
- **注意,更新前请备份你已经设置好的setting文件!**  
## 新功能说明
- **我明天再来更新具体的readme部分 XD**
- **重新写了一遍底层,效果提升4倍,现在允许你只迭代一次就能获得比较完整的效果**
- **为了达到尽可能高效率的性能,脚本只能通过命名添加骨骼,该操作暂时有些反人类,请star来尝试解决问题XD**
- 	<span><span><s><span><span>修改了重力的作用方式</span></span></s></span></span>**又改回去了**
