        ...
        //OYM：把job的点转换成实际的点
        {
            ...
            */
                ...
                else
                {
                    ...
                    pReadWritePoint->position += pFixedPointReadWrite->velocity;
                    pReadWritePoint->velocity -= pFixedPointReadWrite->velocity * 0.05f * pReadPoint->airResistance/ pReadPoint->weight;
                    //OYM：0.05是我试出来的,如果你有更好的值可以填进去
